            ...
            <li className={`timeline_item ${activeClass(1)}`} data-index={1}>
              <div className="t_item">
                  ...
                  <div className="neoh_fn_gallery_1_2">
                    <div className="gallery_in">
                      <div className="item row2">
                        <img src="img/timeline/1/1.gif" alt="" />
                      </div>
                      {/* <div className="item">
                ...
                <div className="t_item_info">
                  ...
                  {/* <p className="fn_desc">Launch on Solana</p> */}
                  {/* <p className="fn_read"></p> */}
                </div>
              </div>
            </li>
                ...
                <div className="t_item_info">
                  ...
                  <h3 className="fn_title">
                    <Link legacyBehavior href="/">
                      Listing on Crypto Data Websites
                    </Link>
                  </h3>
                  <p className="fn_desc">
                    Listing on Coinmarketcap, Coingecko, SolanaHunters, etc
                  </p>
                  {/* <p className="fn_read">
                    <Link legacyBehavior href="/roadmap-single">
            ...
            <li className={`timeline_item ${activeClass(4)}`} data-index={4}>
              <div className="t_item">
                ...
                <div className="t_item_info">
                  ...
                  <p className="fn_desc">
                    Listing on Tier 3 and Tier 2 Exchanges
                  </p>
                </div>
              </div>
            </li>
            ...
            >
              <ul>
                ...
                <li className={activeClass(4)}>
                  <a onClick={() => onClick(4)}>
                    <span className="text">September 26, 2024</span>
                    <span
                      className="circle"
